...
export const OFFICIAL_URL = 'https://app.molycure.com';
export const OFFICIAL_SITE = 'https://molycure.com';
export const OFFICIAL_DOMAIN = 'molycure.com';

export const OG_URL = '/og/cover.png?v=4';

export const GITHUB = 'https://github.com/htzlai/lobe-chat';
export const GITHUB_ISSUES = urlJoin(GITHUB, 'issues/new/choose');
export const CHANGELOG = 'https://molycure.com/changelog';
...
export const FEEDBACK = 'https://github.com/htzlai/lobe-chat/issues/new/choose';
export const PRIVACY_URL = urlJoin(OFFICIAL_SITE, '/privacy');
export const TERMS_URL = urlJoin(OFFICIAL_SITE, '/terms');

export const PLUGINS_INDEX_URL = 'https://chat-plugins.molycure.com';

export const MORE_MODEL_PROVIDER_REQUEST_URL =
  'https://github.com/htzlai/lobe-chat/discussions';

export const MORE_FILE_PREVIEW_REQUEST_URL =
  'https://github.com/htzlai/lobe-chat/discussions';

export const AGENTS_INDEX_GITHUB = 'https://github.com/htzlai/lobe-chat-agents';
export const AGENTS_INDEX_GITHUB_ISSUE = urlJoin(AGENTS_INDEX_GITHUB, 'issues/new');
export const AGENTS_OFFICIAL_URL = 'https://molycure.com/agent';
...
export const BASE_PROVIDER_DOC_URL = 'https://molycure.com/docs/usage/providers';
